...
export const BENCH_ALLOCATION: Record<Position, number> = {
  QB: 1,
  RB: 3,
  WR: 3,
  TE: 1,
  DST: 0,
  K: 0,
}; // Eight reserve slots per team; valuation assumption, not roster limits.
...
export function defaultLeague(): League {
  return {
    ...
    datasetLabel: "Demo pool · fictional projections",
  };
}
